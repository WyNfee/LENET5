...
if(g_do_gradient_descent == true)
    ...
    for i = 1: iteration_time
        ...
        [t_cost_param, t_gradient_param] = function_Ref_CostFunctionTanh_Softmax_BGD(t_packedweightforDescent,g_input_data, g_input_answer, g_layer_one_size, g_layer_two_size, g_reularization_param);
    ...
    s = input('save the loss data?, y to save:','s');
    if(s == 'y')
        save('data_loss_tanh_softmax.mat', 't_cost_data_tanh');
    end
end
