...
conv_data = conv2(image_data, conv_filter, 'valid');

conv_data = conv_data(:);

conv_data = (conv_data - mean(conv_data)) ./std(conv_data);
...
conv_data2 = conv2(image_data, conv_filter, 'valid');

conv_data2 = conv_data2(:);

conv_data2 = (conv_data2 - mean(conv_data2)) ./std(conv_data2);
...
conv_data3 = conv2(image_data, conv_filter, 'valid');

conv_data3 = conv_data3(:);

conv_data3 = (conv_data3 - mean(conv_data3)) ./std(conv_data3);
