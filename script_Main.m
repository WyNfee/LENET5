...
t_full_connection_data_Matrix = function_FullConnectionLayerForwardPropagation(t_pooling_data_Matrix, g_hidden_unit_amount);
t_relu_full_connection_data_Matrix = function_ReLuLayerForwardPropagation(t_full_connection_data_Matrix);
t_classifcation_data_Matrix = function_FullConnectionLayerForwardPropagation(t_relu_full_connection_data_Matrix, g_classification_unit_amount);
t_prediction = function_ClassificationLayer(t_classifcation_data_Matrix, t_pick_data_answer);
