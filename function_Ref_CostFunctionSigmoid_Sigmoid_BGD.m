...
function [r_cost, r_gradient] = function_Ref_CostFunctionSigmoid_Sigmoid_BGD(p_input_weight, p_input_data, p_answer_data, p_layer_one_weight_size, p_layer_two_weight_size, p_regularization_param)
    ...
    t_layer_three_data = function_Utils_SigmoidFunction(t_layer_two_output_data);
    
    %compute the error without regularization
    t_cost_of_network = function_Utils_SigmoidCost(t_layer_three_data, p_answer_data, t_size_input_data(1));
